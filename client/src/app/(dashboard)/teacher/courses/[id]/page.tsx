    ...
    <div>
      ...
      <Form {...methods}>
        <form onSubmit={methods.handleSubmit(onsubmit)}>
          <Header
            ...
            rightElement={
              <div className="flex items-center space-x-4">
                <CustomFormField
                  name="courseStatus"
                  label={methods.watch("courseStatus") ? "Publihed" : "Draft"}
                  type="switch"
          ...
          <div className="flex justify-between md:flex-row flex-col gap-10 font-dm-sans">
            <div className="basis-1/2">
              <div className="space-y-4">
                <CustomFormField
                  ...
                  label="Course Title"
                  type="text"
                  placeholder="Writr course title here"
            ...
            <div className="bg-customgreys-darkGrey mt-4 md:mt-0 p-4 rounded-lg basis-1/2">
              <div className="flex justify-between items-center mb-2">
                ...
                >
                  <Plus className="mr-1 h-4 text-primary-700 group-hover:white-100" />
