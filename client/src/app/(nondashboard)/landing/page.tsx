    ...
    >
        ...
        <div className="landing__hero-content">
          ...
          <div className="landing__cta">
            <Link href="/search" scroll={false}>
              <div className="landing__cat-button">Search for Courses</div>
            </Link>
          </div>
        </div>
      ...
      >
        ...
        <p className="landing__featured-description">
          For the beginner to advanced, in all industries, we have the right
          courses just for and preparing your entire journey for learning and
          making the most
        </p>
